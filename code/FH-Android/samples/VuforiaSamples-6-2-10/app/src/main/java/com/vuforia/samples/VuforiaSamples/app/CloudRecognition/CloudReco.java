    ...
    SampleAppMenuInterface
{
    ...
    private static final String kAccessKey = "fa075b09876332b35bbcf1c598f4c13fbff02603";
    private static final String kSecretKey = "baae357ed4d98444d09e02f4b4f8c777f6742589";
        ...
        } else if (statusCode == TargetFinder.UPDATE_RESULTS_AVAILABLE)
        {
            ...
            if (finder.getResultCount() > 0)
            {
                ...
                if (result.getTrackingRating() > 0)
                {
                    ...
                    System.out.println(result.getMetaData()+result.getUniqueTargetId());
