...
/*
        mAddButton = (Button) findViewById(R.id.button_add_com);
        mAddButton.setOnClickListener(this);
        mUserButton = (Button) findViewById(R.id.button_user);
...
*/
    ...
    {
        Intent i = new Intent(AboutScreen.this,MainActivity.class);
