...
namespace AsImpL
{
    ...
    public class ObjectImporter : MonoBehaviour
    {
        ...
        {
            Loader loader = gameObject.AddComponent<LoaderObj>();
        ...
        public void ImportModelAsync(string objName, string objectId, Transform parentObj, ImportOptions options)
        {
            if (loaderList == null)
            {
            ...
            {
                objName = "DefaultObject";
            }
            allLoaded = false;
            StartCoroutine(loader.Load(objName, objectId, parentObj));
        }
